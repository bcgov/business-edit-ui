<template>
  <div>
      ...
      <v-expand-transition v-if="helpToggle">
        <section class="help-section info-text">
          <header class="help-header mt-4">
            <h2 id='sr-heading' >Help with Special Resolution</h2>
          </header>
          <br/>
          <div>
            ...
            <p>For details on how many members need to vote in a general meeting, refer to the
                <a href="https://www.bclaws.gov.bc.ca/civix/document/id/complete/statreg/99028_01">
                  ...
                  <v-icon dense color="primary" class="ml-1 mt-n0">
                    mdi-open-in-new
                  </v-icon>
                </a>
              </p>
            ...
            <v-card flat class="py-8 px-6">
              <div class="d-flex flex-column flex-sm-row justify-center align-center">
                ...
                <div class="download-link-container py-5">
                  ...
                  <a :href="documentURL" download class="ml-1">{{getSpecialResolutionResource.label}}</a>
                </div>
              </div>
            </v-card>
          </div>
    ...
    <v-divider v-if="!helpToggle" class="mx-4 mt-8" />
  </div>
</template>
