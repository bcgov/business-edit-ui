<template>
  <v-dialog v-model="dialog" width="45rem" persistent :attach="attach" content-class="delete-error-dialog">
    <v-card>
      <v-card-title id="dialog-title">Unable to process request</v-card-title>

      <v-card-text id="dialog-text">
        <!-- display common message -->
        <div class="genErr">
          <p>We are unable to process your request at this time. Please return to the dashboard and try again.</p>
        </div>
