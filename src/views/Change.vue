...
import { ChangeSummary, DocumentsDelivery, TransactionalFolioNumber }
  from '@/components/Alteration/'
import { CertifySection, PeopleAndRoles, StaffPayment, YourCompany } from '@/components/common/'
import { CompletingPartyShared } from '@/components/shared'
import { AuthApiMixin, CommonMixin, FilingTemplateMixin, LegalApiMixin, PayApiMixin } from '@/mixins/'
import { ActionBindingIF, AddressIF, CompletingPartyIF, EmptyFees, EntitySnapshotIF, FeesIF,
  FilingDataIF } from '@/interfaces/'
...
export default class Change extends Mixins(
  ...
  @Getter getUserFirstName!: string // *** TODO: replace these with "getCompletingParty"?
  @Getter getUserLastName!: string
  @Getter getTombstone!: any // TODO // for user email
  ...
  protected addEditCompletingParty (event: CompletingPartyIF): void {
    // *** TODO: Apply new completing party to store.
