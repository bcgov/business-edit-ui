...
describe('Share Structures component', () => {
  ...
  describe('hasOtherCurrency and section banner', () => {
    afterEach(() => {
      store.stateModel.shareStructureStep.shareClasses = shareClasses
    })
    ...
    it('is true when a class uses OTHER currency', async () => {
      store.stateModel.shareStructureStep.shareClasses = [
        { id: '1',
          name: 'A',
          priority: 0,
      ...
      expect(wrapper.find('#other-currency-notice').text()).toContain('Important:')
      expect(wrapper.find('#other-currency-notice').text()).toContain('Other')
    })

    it('is true when a nested series uses OTHER currency', async () => {
      store.stateModel.shareStructureStep.shareClasses = [
        {
          id: '1',
          name: 'A',
    ...
    it('banner is hidden in review mode even with OTHER present', async () => {
      store.stateModel.shareStructureStep.shareClasses = [
        { id: '1',
          name: 'A',
          priority: 0,
