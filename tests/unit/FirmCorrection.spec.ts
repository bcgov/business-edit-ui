...
describe('Firm Correction component', () => {
  ...
  beforeEach(async () => {
    ...
    // GET business info
    get.withArgs('https://business-api.url/businesses/FM1234567')
      .returns(Promise.resolve({
    ...
    // GET addresses
    get.withArgs('https://business-api.url/businesses/FM1234567/addresses')
      .returns(Promise.resolve({
        data: {}
      }))

    // GET parties
    get.withArgs('https://business-api.url/businesses/FM1234567/parties')
      .returns(Promise.resolve({
        data: { parties: [] }
      }))
